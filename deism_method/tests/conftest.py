...
def create_temporary_input_file():
    ...
    geo_file = os.path.join(default_data_path(), "test_room_Deism.geo")
    msh_file = os.path.join(default_data_path(), "test_room_Deism.msh")
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        input_tmp['geo_path'] = os.path.join(
            tmpdirname, "test_room_Deism.geo")
        input_tmp['msh_path'] = os.path.join(
            tmpdirname, "test_room_Deism.msh")
...
def mock_requests_post():
    ...
    """
    with patch("deism_interface.definition.requests.post") as mock_post:
