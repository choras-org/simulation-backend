...
def create_modified_settings_input_file_multi_factory(**settings):
    ...
    **settings : dict
    ...
    def _create_modified_settings_input_file():
        ...
        if 'absorption_coefficients' in settings:
            modified_coefficients = settings['absorption_coefficients']

            # Ensure absorption_coefficients exists
            if 'absorption_coefficients' not in input_tmp:
                input_tmp['absorption_coefficients'] = {}

            # Update all provided coefficients
            input_tmp['absorption_coefficients'].update(modified_coefficients)

        if 'simulationSettings' in settings:
            modified_settings = settings['simulationSettings']
            ...
            input_tmp['simulationSettings'].update(modified_settings)
...
def json_file_factory():
    ...
    ...     interface = MoDARTMethod(config_file)
    ...     # test logic...
    """
